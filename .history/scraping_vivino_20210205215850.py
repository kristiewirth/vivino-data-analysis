...
fig.plot(x_line, y_line, "--", color="black")
fig.xlabel("Price")
fig.ylabel("Rating")
fig.title("Comparing ratings of wines vs pricing")
fig.savefig("graph_trendline.png", facecolor='white', edgecolor="none", transparent=True)
