...
fig.scatter(x, y, color="pink")
# define a sequence of inputs between the smallest and largest known inputs
x_line = np.arange(min(x), max(x), 1)
# calculate the output for the range
y_line = objective(x_line, a, b, c, d, e, f)
# create a line plot for the mapping function
fdg.plot(x_line, y_line, "--", color="black")
fdg.xlabel("Price")
fdg.ylabel("Rating")
fdg.title("Comparing ratings of wines vs pricing")
fdg.savefig("graph_trendline.png", facecolor='white', edgecolor="none", transparent=True)
