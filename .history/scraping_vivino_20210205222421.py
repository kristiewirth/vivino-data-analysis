...
# Save large file for a checkpoint to return to later
...
# Calculating average increases in ratings over price increases
previous = 0
diffs = []
...
# Source for below: https://machinelearningmastery.com/curve-fitting-with-python/
